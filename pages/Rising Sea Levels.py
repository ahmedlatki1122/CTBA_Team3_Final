...
yorktown = pd.read_csv('CTBA_Team3_Final/data/Yorktown.csv', header= 4, index_col=False)
yorktown.head()
...
WP = pd.read_csv('CTBA_Team3_Final/data/Windmill Point.csv', header = 4, index_col=False)
WP.head()
...
Wachapreague = pd.read_csv('CTBA_Team3_Final/data/Wachapreague.csv', header = 4, index_col=False)
Wachapreague.head()
...
SewellsPoint = pd.read_csv('CTBA_Team3_Final/data/Sewells Point.csv', header = 4, index_col=False)
SewellsPoint.head()
...
Lewisetta = pd.read_csv('CTBA_Team3_Final/data/Lewisetta.csv', header = 4, index_col=False)
Lewisetta.head()
...
Kiptopeke = pd.read_csv('CTBA_Team3_Final/data/Kiptopeke.csv', header = 4, index_col=False)
Kiptopeke.head()
...
Dahlgren = pd.read_csv('CTBA_Team3_Final/data/Dahlgren.csv', header = 4, index_col=False)
Dahlgren.head()
